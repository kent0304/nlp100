...
for epoch in range(epoch_num):
    ...
    with torch.no_grad():
        ...
        y_valid_loss = loss_fn(y_valid_pred, y_valid)
        print('epoch', i, ' accuracy(train): ' , accuracy(y_train_pred, y_train), 'accuracy(valid): ', accuracy(y_valid_pred, y_valid))
